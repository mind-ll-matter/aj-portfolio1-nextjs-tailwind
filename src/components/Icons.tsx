// RESOURCE: Convert SVG icons using https://react-svgr.com/playground/
// RESOURCE: Remove background: https://www.erase.bg/upload
// RESOURCE: Convert image to SVG: https://www.adobe.com/express/feature/image/convert/svg


import * as React from "react"

import { SVGProps } from "react"
interface TypeIcons extends React.ComponentProps<"svg"> {
    className?: string
}
...
// </svg> export const SunIcon0 = ({ className, ...rest }: TypeIcons) => (
//   <svg
//     xmlns="http://www.w3.org/2000/svg"
//     width="24"
//     height="24"
...
// export const SunIcon1 = ({ className, ...rest }: TypeIcons) => (
//   <svg 
//   xmlns="http://www.w3.org/2000/svg"
//   viewBox="0 0 24 24"
//   className={`w-full h-auto ${className}`}
...
// export const MoonIcon1 = ({ className, ...rest }: TypeIcons) => (
//   <svg
//     xmlns="http://www.w3.org/2000/svg"
//     width="1em"
//     height="1em"
...
// export const MoonIcon0 = ({ className, ...rest }: TypeIcons) => (
//   <svg
//     xmlns="http://www.w3.org/2000/svg"
//     width="24"
//     height="24"
...
export const LinkArrow = ({ className, ...rest }: TypeIcons) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={24}
    height={24}
...
export const CircularText = ({ className, ...rest }: TypeIcons) => (
  <svg
  xmlns="http://www.w3.org/2000/svg"
  width="496"
  height="496"
...
export const CircularText2 = ({ className, ...rest }: TypeIcons) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={400}
    height={400}
    ...
    {...rest}
    >
    <path d="M178.7 38.7c-.4.3-.7 1.2-.7 2 0 1.5 2.6 1.8 3.4.4.7-1.1-1.8-3.3-2.7-2.4zM120.3 40.2c-2.4.6-4.3 1.7-4.3 2.4s.9 5.3 2.1 10.4c1.7 7.4 2.4 9 3.7 8.6 1-.2 3.8-.9 6.5-1.6 6.6-1.8 10.1-6 9.4-11.4-1.1-7.6-7.7-10.8-17.4-8.4zm12.5 4.4c2.7 3.1 2.9 7.7.3 10.3-1.8 1.8-9.9 4.7-10.6 3.9-.4-.5-3.5-15.1-3.3-15.4.2-.1 1.9-.7 3.8-1.2 4.5-1.3 6.9-.7 9.8 2.4zM145.5 42.1c-3.1 1.8-4.5 4-4.5 7.4 0 6.1 5.5 9.8 11.3 7.6 4.1-1.6 3.2-3-1.3-2.4-3 .4-4.5.1-6-1.2-2.9-2.6-1.6-3.5 5.1-3.5 5.1 0 5.9-.2 5.9-1.9 0-4.5-6.5-8.2-10.5-6zm6.9 3.5c2.7 2.6 1.8 3.4-3.9 3.4-3 0-5.5-.4-5.5-.9 0-1.8 3.1-4.1 5.5-4.1 1.3 0 3.1.7 3.9 1.6zM162.3 43.1c-4.6 1.7-3.5 7.3 1.8 8.4 3.3.7 5 3.2 3 4.4-1.5.9-5.9.2-6.7-1-.8-1.4-2.4-1-2.4.5 0 1.8 6.4 4 9.5 3.2 2.5-.6 3.9-3.4 3-5.7-.3-.8-2.3-2.2-4.5-3.1-2.2-.9-4-2.1-4-2.8 0-1.8 3.1-2.4
1.8-4.8.5-7.1 2.6-2.6 4-3 5-1.4zM229.3 89.3c-4 2.8-5.9 4.7-5.4 5.5.5.9 1.9.4 4.7-1.8 4.3-3.3 7.5-3.8 9.4-1.5.7.8 1.6 1.2 2.1.9 1.6-.9 1-2.4-1.5-3.5-1.4-.7-2.2-1.7-1.9-2.5.9-2.3-1-1.6-7.4 2.9zM55.2 100.7c-2 .8-4.4 6.2-3.6 8.5.5 1.7.3 2-1 1.5-.9-.4-1.6-.1-1.6.6s3.8 2.9 8.4 5c11.8 5.2 11.6 5.1 11.6 3.4 0-.9-1.5-2.1-3.5-2.7l-3.6-1.2 2.6-2.3c3.5-3.3 3.5-8.6-.1-11.4-2.5-2-6.3-2.6-9.2-1.4zm6.3 2.5c4.4 2 4.5 7.5.2 10.2-2.5 1.6-7-.5-8.2-3.8-.8-2.5-.6-3.1 1.8-5.2 3.3-2.8 2.9-2.7 6.2-1.2zM242.7 112.6c-1.4 1.5-.6 3.4 1.4 3.4 1.4 0 1.9-.5 1.7-1.7-.3-1.8-2-2.7-3.1-1.7zM47.6 121.1c-4.8 3.8-2.6 13.6 3.2 14 7.5.5 11.9-4.7 9.2-11.1-2.1-5-8-6.4-12.4-2.9zm9.2 2.1c2.9 2.9.4 9.8-3.6 9.8-4.8 0-7.5-4.8-5.2-9.1 1.2-2.2 6.8-2.7 8.8-.7zM36 139.3c0 1.2 2.2 1.6 10.5 2.2 12.7.8 11.9.9 12.3-.3.1-.5-3-1.2-7-1.6-4-.4-9.2-.9-11.5-1.2-3.4-.5-4.3-.3-4.3.9zM242 145.4c0 1.2 1 1.6 4.6 1.6h4.6l-.4 5.5c-.2 3.9.1 5.5 1 5.5.8 0 1.2-1.8 1.2-5.5V147h8v6.5c0 3.7.4 6.5 1 6.5s1-3.2 1-7.5V145h-8.2c-4.6 0-9.3-.3-10.5-.6-1.7-.5-2.3-.2-2.3 1zM44.5 148.5c-5.9 5.8.5 15.1 8.5 12.4 1.7-.6 3.5-1.9 4-2.9 1.5-2.7 1.2-8.6-.4-9.9-1.7-1.5-2.8-.1-1.5 1.9 1.4 2.4 1 5.6-.9 7.3-1 1-2.2 1.7-2.5 1.7-.4 0-.7-2.9-.7-6.5 0-5.9-.2-6.5-2-6.5-1.2 0-3.2 1.1-4.5 2.5zm4.5 3.9c0 1.9.3 4.1.6 5 1 2.6-2.4 1.9-4.2-.9-1.4-2.1-1.5-3.1-.6-5 1.7-3.8 4.2-3.2 4.2.9zM244.5 162.2c-4.1 2.3-5.6 6.8-3.9 11.3.9 2.3 6.2 4.8 9 4.1 7.3-1.9 8.8-11.8 2.3-15.1-3.3-1.8-4.7-1.8-7.4-.3zm7.5 3.8c2.4 2.4 2.5 3.8.4 6.8-2.2 3.2-7.3 2.7-9.3-.9-1.3-2.4-1.3-2.9.2-5.3 2.1-3.2 5.9-3.4 8.7-.6zM43 165.9c0 1.2 1.8 1.8 8.3 2.6 3.2.4 5.7 1 5.7 1.4-.1.3-2.5 2.3-5.5 4.4-3 2.1-5.5 4.5-5.5 5.4 0 1.2.7 1.1 3.3-.9 1.7-1.3 4.9-3.7 7-5.2 4.2-3.2 4.7-5.3 1.5-6.1-12.4-2.8-14.8-3-14.8-1.6zM59.6 179.8c-.3.5.3 1.7 1.4 2.7 2.3 2.1 2.6 6.7.6 8.4-1.1.9-1.8 0-3.6-4.9-1.2-3.3-2.6-6-2.9-6-2 0-5.1 4.4-5.1 7.1 0 4.2 1.5 6.5 4.9 7.7 3.9 1.4 9.1-1.2 10.4-5 1.4-4.4-3.7-13.2-5.7-10zm-2.7 8.5c2 4.6 2 4.7.1 4.7-4 0-6.6-6-3.8-8.8 1.4-1.4 1.3-1.6 3.7 4.1zM236.7 181.8c-1 1-1.7 3.1-1.7 4.7 0 1.5-.7 3.3-1.6 4-1.4.9-.5 1.6 5.7 4.2 5.1 2.2 7.7 2.8 8.4 2.1.7-.7.6-1.2-.1-1.5-.6-.2-3.1-1.4-5.5-2.6-4.6-2.3-6.1-5.5-3.9-8.3 1.7-1.9 4-1.8 9.4.6 3.9 1.6 4.6 1.7 4.6.4 0-1.6-7.9-5.4-11.4-5.4-1.3 0-3 .8-3.9 1.8zM229.6 195.7c-1.1 1.2-.6 1.8 3.4 4.3 4.3 2.6 6 6.2 4.3 8.9-1.7 2.7-5 2.4-9.6-.8-4-2.7-5.7-3-5.7-1 0 1.3 9.6 6.9 11.8 6.9 2.9 0 6.2-3.4 6.2-6.5 0-1.8.4-2.3 1.5-1.9.9.4 1.5.1 1.5-.7 0-1.6-12.5-10.1-13.4-9.2zM59.8 198.6c-6 3.2-6.4 9.5-1.3 17.2l3.6 5.2 7.7-5.1c10.2-6.8 9.8-6.3 7.3-10.3-4.9-7.9-11.1-10.4-17.3-7zm12.9 5.2c1.8 2 3.3 3.9 3.3 4.2-.1.3-3 2.5-6.5 4.9-7.3 4.9-8 4.7-11-1.8-1.5-3.4-1.5-4.3-.4-6.7 1.7-3.5 5.6-5.6 8.9-4.9 1.4.3 4 2.2 5.7 4.3zM217.2 213.1c-1.3.5-2.9 2.2-3.5 3.9-.6 1.6-1.6 2.9-2.2 2.7-2.8-.6-1.4 1.8 5.4 8.7 4 4.2 7.7 7.6 8.2 7.6 1.6 0 1-1.6-1.6-4-3-2.8-3.2-4-.6-4 2.3 0 6.1-4.5 6.1-7.2 0-3-1.8-5.6-5-7.3-3.3-1.7-3.6-1.7-6.8-.4zm7 3.6c3.8 3.5 1.2 9.3-4.2 9.3-2.2 0-3.3-.7-4.3-2.8-1.6-3-1.2-5.1 1.1-7 2.2-1.7 5.2-1.5 7.4.5zM83.9 220.5c-3.9 2.1-5.2 6.5-3.1 10.7 1.2 2.3 2.5 3.4 4.5 3.6 3.3.4 3.3.7.2 4.8-1.6 2.1-2.1 3.5-1.4 3.9 1.3.8.4 1.7 8.2-8.5 6.3-8 7.4-10.6 4.2-9.3-.9.3-1.5-.1-1.5-.9 0-3.9-7-6.6-11.1-4.3zm7.5 2.8c2.6 1.9 2.4 6.7-.4 8.9-2.8 2.3-3.2 2.3-6.4-.3-6.1-4.8.5-13.2 6.8-8.6zM198.9 228c-1.7 1.6-2.7 3.5-2.3 4.1.4.7 1.4.3 2.8-1.4 2.6-3.1 4.4-3.7 7.5-2.5 2.4.8 2.3 1-3 4.5-3 2-5.6 3.8-5.9 4-1.1 1 4.4 4.3 7.2 4.3 3.6 0 7.8-4 7.8-7.4 0-1.3-1.2-3.8-2.6-5.5-3.4-4.1-7.5-4.2-11.5-.1zm11.1 7.4c-1 2.8-5.4 4.4-7.4 2.6-1.4-1.1-1.1-1.6 2.6-4 4.5-2.8 6.2-2.3 4.8 1.4zM101 230.9c0 .6 1.1 1.1 2.5 1.1 3 0 6.5 3.2 6.5 6.1 0 1.1-.3 1.9-.7 1.7-.5-.2-3.1-1.5-5.9-3-2.8-1.5-5.4-2.4-5.8-2.1-.3.4-.6 2.3-.6 4.4 0 4.3 3 7.1 7.6 7.1 6 0 9.6-8.3 5.7-13.1-2-2.4-9.3-4.1-9.3-2.2zm3.3 8.6c2 1 3.6 2.4 3.4 2.9-.5 1.6-5.6 1.9-7.3.5-1.4-1.2-2-6.4-.6-5.7.4.2 2.4 1.2 4.5 2.3zM189.7 232.6c-.3.4.3 2.4 1.3 4.5 2.4 4.6 2.5 7.2.5 8.9-.8.7-1.5 1.9-1.5 2.6 0 1.9 2.6.7 3.8-1.9.6-1.2 1.1-1.6 1.1-1 .1.7.8 1.3 1.7 1.3.9 0 1.4-.6 1.1-1.3-2.7-6.8-6.1-13.7-6.7-13.7-.4 0-.9.3-1.3.6zM118.2 242.9c-1.7 3.1-4.3 7.5-5.7 9.8-2 3.3-2.3 4.3-1.1 4.3.8 0 3.4-3.4 5.8-7.5 2.3-4.1 4.6-7.5 4.9-7.5.3 0 1 3.9 1.5 8.7.5 4.9 1.4 8.8 2 9 .7.2 3.4-3.1 6-7.4 2.7-4.2 5-7.1 5.2-6.3.1.8.6 4.8 1 8.9.4 4.9 1.2 7.6 2.1 7.9 1.4.5 1.2-4.4-.6-17.6-.8-6.3-3.1-5.5-7.8 2.8-2.2 3.8-4.3 7-4.7 7-.3 0-.9-3.8-1.3-8.4-.9-10.9-2.7-11.8-7.3-3.7zM165.7 246.6c-1.4 1.5-.6 3.4 1.4 3.4 1.4 0 1.9-.5 1.7-1.7-.3-1.8-2-2.7-3.1-1.7z" />
  </svg>
);
